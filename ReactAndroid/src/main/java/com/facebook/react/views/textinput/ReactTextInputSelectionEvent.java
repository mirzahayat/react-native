...
/* package */ class ReactTextInputSelectionEvent extends Event<ReactTextInputSelectionEvent> {
  ...
  @Deprecated
  public ReactTextInputSelectionEvent(int viewId, int selectionStart, int selectionEnd, float cursorPositionX, float cursorPositionY) {
    this(-1, viewId, selectionStart, selectionEnd, cursorPositionX, cursorPositionY);
  }

  public ReactTextInputSelectionEvent(
      int surfaceId, int viewId, int selectionStart, int selectionEnd, float cursorPositionX, float cursorPositionY) {
